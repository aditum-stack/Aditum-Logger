 ...
 * 日志分析
 */
public class MapReduceLogAnalyzer extends Configured implements Tool {

    public static void main(String[] args) throws Exception {
        ToolRunner.run(new MapReduceLogAnalyzer(), args);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        // 2、一定要打包运行，必须写下面一行代码
        job.setJarByClass(MapReduceLogAnalyzer.class);
